...
class Registration
{
    ...
    private function registerNewUser($user_email, $user_password, $user_password_repeat, $first_name, $middle_name, $last_name, $telephone_number, $date_of_birth)
    {
        ...
        // finally if all the above checks are ok
            ...
            $query_check_user_email = $this->db_connection->prepare('SELECT user_email FROM gebruikers WHERE user_email=:user_email');
            ...
            if (count($result) > 0) {
                ...
                if ($query_new_user_insert) {
                    ...
                    if ($this->sendVerificationEmail($user_id, $user_email, $user_activation_hash)) {
                        ...
                        $query_delete_user = $this->db_connection->prepare('DELETE FROM gebruikers WHERE user_id=:user_id');
    ...
    public function verifyNewUser($user_id, $user_activation_hash)
    {
        ...
        if ($this->databaseConnection()) {
            ...
            $query_update_user = $this->db_connection->prepare('UPDATE gebruikers SET user_active = 1, user_activation_hash = NULL WHERE user_id = :user_id AND user_activation_hash = :user_activation_hash');
