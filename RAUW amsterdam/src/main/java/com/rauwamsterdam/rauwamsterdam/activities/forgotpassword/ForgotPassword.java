package com.rauwamsterdam.rauwamsterdam.activities.forgotpassword;
...
public class ForgotPassword extends Activity implements View.OnClickListener {
    ...
    private static final String LOGIN_URL = "http://www.rauwamsterdam.com/php-login-advanced-2/password_reset.php";
